-- Supabase Database Schema for Dating App
...
-- Create policies (you may want to customize these based on your security requirements)
...
CREATE POLICY "Allow all operations on payment_orders" ON payment_orders FOR ALL USING (true);
